    ...
    <section className='relative z-1 overflow-hidden bg-primary py-17.5 lg:py-22.5 xl:py-25'>
      ...
      <div className='hidden sm:block'>
        <div className='absolute bottom-0 left-0 -z-1'>
          <Image src='/images/cta/cta-grid-01.svg' alt='grid' width={376} height={376} />
        </div>
        <div className='absolute right-0 top-0 -z-1'>
          <Image src='/images/cta/cta-grid-02.svg' alt='grid' width={376} height={376} />
        </div>
        <div className='absolute bottom-0 left-0 -z-1'>
          <Image src='/images/cta/cta-shape-01.svg' alt='grid' width={1010} height={404} />
        </div>
        <div className='absolute bottom-0 right-0 -z-1'>
          <Image src='/images/cta/cta-shape-02.svg' alt='grid' width={935} height={404} />
        </div>
      </div>
    </section>
  );
